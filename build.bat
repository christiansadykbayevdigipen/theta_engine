...
%D% -G "MinGW Makefiles" -D CMAKE_C_COMPILER=C:\MinGW\bin\gcc.exe -S theta/src -B theta/build
...
%D% -G "MinGW Makefiles" -D CMAKE_C_COMPILER=C:\MinGW\bin\gcc.exe -S sandbox/src -B sandbox/build
