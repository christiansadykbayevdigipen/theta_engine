...
namespace theta
{
        ...
        m_Descriptor(descriptor)
    {
        ...
        m_Window = theta_window_init(m_Descriptor.Width, m_Descriptor.Height, concattedString.c_str(), m_Descriptor.Api);
    ...
    void Application::Run()
    {
        ...
        theta_timer_reset();
        f64 accumulator = 0.0;
        while (!m_Window->close_requested(m_Window))
        {
            f64 frame_time = theta_timer_get_elapsed();
            theta_timer_reset();
